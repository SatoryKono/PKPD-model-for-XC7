...
SECTION_TITLE_OVERRIDES = {
    ...
    "Cyp Cystitis": "Модель цистита, индуцированного циклофосфамидом (крысы).",
}
FIGURE_CAPTION_OVERRIDES = {
    ...
    "fig3_2_capsaicin_internalization.png": (
        ...
        "Интернализация H3 рецепторов после индукции патологии."
    ),
    ...
    "fig9_1_cyp_cystitis_histamine.png": (
        "Рисунок 9.1 Модель цистита, индуцированного циклофосфамидом. "
        "Изменение концентрации гистамина после индукции патологии."
    ),
    "fig9_2_cyp_cystitis_internalization.png": (
        "Рисунок 9.2 Модель цистита, индуцированного циклофосфамидом. "
        "Интернализация H3 рецепторов после индукции патологии."
    ),
    "fig9_3_cyp_cystitis_gsignaling.png": (
        "Рисунок 9.3 Модель цистита, индуцированного циклофосфамидом. "
        "Уровень функциональной активности H3 рецепторов после индукции патологии."
    ),
    "fig9_4_cyp_cystitis_xc7_concentration.png": (
        "Рисунок 9.4 Модель цистита, индуцированного циклофосфамидом. "
        "Концентрация XC7 в тканях после индукции патологии."
    ),
}
EMU_PER_INCH = 914400
